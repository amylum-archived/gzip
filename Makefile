...
CONF_FLAGS = 
CFLAGS = -static -static-libgcc -Wl,-static -Wno-error

PACKAGE_VERSION = $$(git --git-dir=upstream/.git describe --tags | sed 's/v//;')
PATCH_VERSION = $$(cat version)
VERSION = $(PACKAGE_VERSION)-$(PATCH_VERSION)

.PHONY : default submodule deps build_container manual container deps build version push local
